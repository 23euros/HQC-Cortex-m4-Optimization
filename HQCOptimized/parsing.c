 ...
 */
void PQCLEAN_HQC128_CLEAN_hqc_secret_key_from_string(uint16_t *xindexes, uint16_t *yindexes, uint8_t *sigma, uint8_t *pk, const uint8_t *sk) {
 ...
 * @param[in] sk String containing the secret key
 */
void PQCLEAN_HQC128_CLEAN_hqc_secret_key_from_string_slow(uint64_t *x, uint64_t *y, uint8_t *sigma, uint8_t *pk, const uint8_t *sk) {
    seedexpander_state sk_seedexpander;
 ...
 * @param[in] sk String containing the secret key
 */
void PQCLEAN_HQC128_CLEAN_hqc_secret_key_from_string_slow_indexes(uint64_t *x, uint64_t *y, uint16_t *yindexes, uint8_t *sigma, uint8_t *pk, const uint8_t *sk) {
    seedexpander_state sk_seedexpander;
    ...
    PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight(&sk_seedexpander, x, PARAM_OMEGA);
    PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight_and_index(&sk_seedexpander, y, PARAM_OMEGA, yindexes);
    memcpy(pk, sk + SEED_BYTES + VEC_K_SIZE_BYTES, PUBLIC_KEY_BYTES);
